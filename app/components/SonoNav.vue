    ...
    <div class="fixed top-0 bg-transparent border-b border-base-100 backdrop-blur-lg z-10 navbar p-0 px-4 text-secondary">
            ...
            <div class="flex-none lg:hidden">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-content menu bg-base-100 rounded-sm z-1 w-32 p-2 shadow-sm text-base-content" tabindex="0">
                        <li>
                            <a :class="{ 'bg-secondary/25 shadow-sm': $route.path === '/' }" @click="handleDaisyUIDropdownClick(() => $router.push(`/`))">
        ...
        <section class="hidden lg:inline-flex navbar-center">
            <ul class="menu menu-horizontal gap-2">
                ...
                <li>
                    <a :class="{ 'bg-secondary/25 shadow-sm': $route.path.startsWith('/dashboard') }" @click="$router.push(`/dashboard`)">
                        <Icon class="-translate-y-0.25" name="ic:round-dashboard" size="18" />
                        面板
                    </a>
                </li>
                <li>
                    <a :class="{ 'bg-secondary/25 shadow-sm': $route.path.startsWith('/blog') }" @click="$router.push(`/blog`)">
                        <Icon class="-translate-y-0.25" name="ic:round-event-note" size="18" />
                        博客
                    </a>
                </li>
                <li>
                    <a :class="{ 'bg-secondary/25 shadow-sm': $route.path === '/company/contact' }" @click="$router.push(`/company/contact`)">
                        <Icon class="-translate-y-0.25" name="ic:round-contact-support" size="18" />
                        联系我们
                    </a>
                </li>
        ...
        <section class="navbar-end">
            ...
            <div v-else class="dropdown dropdown-end">
                ...
                <ul class="dropdown-content menu bg-base-100 rounded-sm z-1 w-32 p-2 shadow-sm text-base-content" tabindex="0">
                    ...
                    <li>
                        <a :class="{ 'cursor-not-allowed! opacity-50': logging_out }" @click="logging_out ? null : handleDaisyUIDropdownClick(handleLogout)">
